    ...
    <>
      <div className="w-full">
        <ul className="flex flex-col h-screen md:p-1 pt-8 gap-y-6 w-full">
          ...
          <Link
            to="/doctor"
            className="text-xs md:text-sm items-center w-full border-b p-1 rounded-md flex gap-1 hover:bg-slate-100 hover:text-yellow-500 font-bold transition-all text-slate-50"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
